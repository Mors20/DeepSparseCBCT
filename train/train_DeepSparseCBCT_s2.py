...
def main(cfg_path: str):
    ...
    train_dataset = DenoisingDataset(
            input_dir=cfg.dataset.input_dir, gt_dir=cfg.dataset.gt_dir,augmentation=True,split='train')
    val_dataset = DenoisingDataset(
            input_dir=cfg.dataset.input_dir,gt_dir=cfg.dataset.gt_dir, augmentation=False,split='val')
